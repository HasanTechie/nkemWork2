    ...
    <div id="page-menu" class="no-sticky">
        ...
        <div id="page-menu-wrap">
            ...
            <div class="container clearfix">
                ...
                <nav>
                    <ul>
                        <li class="current"><a href="portfolio-1.html"><div>Default</div></a></li>
                        <li><a href="portfolio-1-alt.html"><div>Alternate</div></a></li>
                        <li><a href="portfolio-1-full.html"><div>Full Width</div></a></li>
                        <li><a href="portfolio-1-full-alt.html"><div>Full Width - Alternate</div></a></li>
                    </ul>
                </nav>
                            ...
                            <div class="fslider" data-arrows="false" data-speed="400" data-pause="4000">
                                <div class="flexslider">
                                    <div class="slider-wrap">
                                        <div class="slide"><a href="portfolio-single-gallery.html"><img src="images/portfolio/1/4.jpg" alt="Morning Dew"></a></div>
                                        <div class="slide"><a href="portfolio-single-gallery.html"><img src="images/portfolio/1/4-1.jpg" alt="Morning Dew"></a></div>
                                    </div>
                                </div>
                            </div>
