            ...
            <div class="col_half">
                ...
                <div class="contact-widget">
                    ...
                    <form class="nobottommargin" id="template-contactform" name="template-contactform"
                          action="include/sendemail.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col_full">
                            <label for="template-contactform-message">Upload CV
                                <small>*</small>
                            </label>
                            <input type="file" id="template-contactform-file" name="template-contactform-file" value=""
                        ...
                        <div class="col_full">
                            <button name="submit" type="submit" id="submit-button" tabindex="5" value="Submit"
                                    class="button button-3d nomargin">Apply for Job
                            </button>
                        </div>
            ...
            <div class="row clear-bottommargin">
                ...
                <div class="col-md-3 col-sm-6 bottommargin clearfix">
                    <div class="feature-box fbox-center fbox-bg fbox-plain">
                        ...
                        <h3>Make a Video Call<span class="subtitle">ExpressOnSkype</span></h3>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 bottommargin clearfix">
                    <div class="feature-box fbox-center fbox-bg fbox-plain">
                        ...
                        <h3>Follow on Twitter<span class="subtitle">123K Followers</span></h3>
                    </div>
                </div>
